        ...
        var exploding_boxplot = function(data,aes)
        {
            ...
            var draw_boxplot = function(s){
                ...
                s.select('line.median')
                    ...
                    .attr('y2',function(d){return miny = yscale(d.quartiles[1])})
                    .attr('class', "gary")
                    /*.append("text")
                    .attr('class', "garytext")
                    .text(function(d){return d.quartiles[1].toPrecision(2)})
                    .attr("dx", -6)
                    .attr("dy", ".32em")
                    .attr("x",0)
                ...
                var x0 = this.__chart__ || d3.scale.linear()
                        .domain([0, Infinity])
                        .range(x1.range());
                var quartilesData = s[0][0].__data__.quartiles;
                var boxTick = s.selectAll("gary")
                    .data(quartilesData);
